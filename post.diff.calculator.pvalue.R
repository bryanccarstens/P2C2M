...
### Each locus ###
  ...
  p_sig <- mapply(pp_pvalue, post_df, post_pred_df)
...
### Across Loci ###
  ...
  p_sig_all <- pp_pvalue(unlist(post_df), unlist(post_pred_df))
